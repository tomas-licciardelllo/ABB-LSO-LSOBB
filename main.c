        ...
        if((operacion == 1 || operacion == 2 ||operacion == 3)){
            if((operacion == 1 || operacion == 2)&& (aux.DNI>0))
            {
                        ...
                        if(operacion == 1){
                            ...
                            if(aux.DNI<99999999 && listaO->ultimo != 109)
                            {
                                printf("Alta ListaO\n");
                                alta_LSO(listaO, aux);
                            }
                ...
                if(operacion == 3)
                {
                   ...
                   if(aux.DNI < 99999999){
                    ...
                    printf("Evocar en lsobb.\n");
                    evocar_LSOBB(*listaBB,aux.DNI);
                    printf("evocar en arbol.\n");
...
int main()
{
    ...
    /*if( memorizar_datos(&arb,&lista_ord,&lista_ordBB)== 0){
       ...
       while(opcion!=4){
        ...
        if(opcion==3){
            memorizar_datos(&arb,&lista_ord,&lista_ordBB);
            getchar();
            getchar();
            system("cls");
